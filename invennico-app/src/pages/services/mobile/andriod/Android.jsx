  ...
  return (
    ...
    <div className="container-fluid">
     ...
     <main>
        ...
        <h1  className='ms-md-5 ps-md-5'>Why Hire Andriod Developer from Innvennico</h1>
            <div className="d-flex gap-4 align-items-center  justify-content-center">
                <div className="left-content ">
                    
                    <p className='ps-md-0 ms-md-0 align-self-start'>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, <br/> 
                        sed diam nonummy nibh euismod tincidunt ut laoreet <br/>
                         dolore magna aliquam erat volutpat. Ut wisi enim ad <br/>
                          minim veniam, quis nostrud exerci tation ullamcorper <br/>
                          suscipit lobortis nisl ut aliquip ex ea commodo consequat.</p>
        ...
        <section className="android-hire">
            ...
            <div className="android-hire-salary">
                <div className="row g-4  mx-md-5 px-md-5  ">
                    <div className="col-md-4">
                        <div className="card">
                            <div className="card-body">
                                <h4 className='card-title text-center my-md-4'>Junior Developer</h4>
                                <p className="price text-center">$300 /<span className='opacity-50'> mo </span> </p>
                               ...
                               <li className='mb-3 mx-md-0 px-md-0'>   <span className='ms-md-0 ps-md-0'>
                                 <svg xmlns="http://www.w3.org/2000/svg" 
                                 width="25" height="25" fill="currentColor"
                    ...
                    <div className="col-md-4">
                        <div className="card card2">
                            <div className="card-bordy">
                                <h4 className='card-title text-center my-md-4'>Mid Level Developer</h4>
                    ...
                    <div className="col-md-4">
                        <div className="card3">
                            <div className="card-bordy">
                                <h4 className='card-title text-center my-md-4'>Senior Developer</h4>
                                <p className="price text-center">$1000 /<span className='opacity-50'> mo </span> </p>
                                  <h5 className='text-center my-md-5'>What’s included</h5>
                                  <ul className=' '>
                                    <li className='mb-3'>   <span>
                                 <svg xmlns="http://www.w3.org/2000/svg" 
