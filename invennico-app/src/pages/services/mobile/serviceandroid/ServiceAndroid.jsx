...
function ServiceAndroid() {
  return (
    ...
    <div className="container-fluid">
      ...
      <main>
        <section className="serviceandroid-hero">
            <div className="serviceandroid-hero-holder">
                <div className="d-flex gap-4 align-items-center justify-content-center">
                    ...
                    <div className="right-holder">
                        <img src="https://invennico-site.vercel.app/assets/android-d16f174c.png" alt="" className="img-fluid img" />
                    </div>
                </div>
            </div>
        ...
        <section className="serviceandroid-project">
        ...
        <section className="serviceandroid-business">
         ...
         <section className='serviceandroid-solution'>
         ...
         <section className="serviceandroid-technology  ">
        ...
        <div className="row gx-3 gy-4  ">
         ...
         <section className="serviceandroid-question">
