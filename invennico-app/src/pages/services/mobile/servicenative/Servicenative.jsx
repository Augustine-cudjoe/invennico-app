...
import "./servicenative.scss"
import {Link} from "react-router-dom"

function Servicenative() {
  return( 
    <div className='servicenative'>
    ...
    <div className="container-fluid">
      ...
      <main>
        <section className="servicenative-hero">
            <div className="serviceandroid-hero-holder">
                <div className="d-flex gap-4 align-items-center justify-content-center">
                    <div className="left-holder">
                        <h1>React Native <br/> Development</h1>
                    ...
                    <div className="right-holder">
                        <img src="https://invennico-site.vercel.app/assets/react-89c29de5.png" alt="" className="img-fluid img" />
                    </div>
                </div>
            </div>
        ...
        <section className="servicenative-project">
        ...
        <section className="servicenative-business">
         ...
         <section className='servicenative-solution'>
         ...
         <section className="servicenative-technology  ">
        ...
        <div className="row gx-3 gy-4  ">
         ...
         <section className="servicenative-question">
