...
import "./webpress.scss"
function Webpress() {
  return (
    <div className='webpress'>
            ...
            <div className="webpress-hero-holder">
                <div className="d-flex gap-2 align-items-center justify-content-center">
                    ...
                    <div className="right-holder">
                        <img src="https://invennico-site.vercel.app/assets/wordpress-2d45b19e.png" alt="" className="img-fluid img" />
                    </div>
                </div>
            </div>
