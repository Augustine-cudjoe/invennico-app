...
function Mobiledesigns() {
  return (
    <div className='mobiledesigns'>
    ...
    <div className="container-fluid">
      ...
      <main>
        <section className="mobiledesigns-hero">
            <div className="webpress-hero-holder">
                <div className="d-flex gap-2 align-items-center justify-content-center">
                    <div className="left-holder">
                        <h1>Mobile App UI/UX <br/> Designs </h1>
                    ...
                    <div className="right-holder">
                        <img src="https://invennico-site.vercel.app/assets/apple-54ee9d79.png" alt="" className="img-fluid img" />
                    </div>
                </div>
            </div>
            <div className="ioapp-services">
                <div className="d-flex align-items-center justify-content-between">
                    <div className=" ms-md-4 ps-md-4 ioapp-left-holder">
                        <h1> Mobile App UI/UX  <br/>Designs Services</h1>
                        <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit,<br/>
        ...
        <section className="mobiledesigns-project">
        ...
        <section className="mobiledesigns-business">
         ...
         <section className='mobiledesigns-solution'>
         ...
         <section className="mobiledesigns-technology  ">
        ...
        <div className="row gx-3 gy-4  ">
         ...
         <section className="mobiledesigns-question">
