...
function Angular() {
  return( 
    ...
    <div className="container-fluid">
      ...
      <main>
        <section className="angular-hero">
            <div className="serviceandroid-hero-holder">
                <div className="d-flex gap-4 align-items-center justify-content-center">
                    ...
                    <div className="right-holder">
                        <img src="https://invennico-site.vercel.app/assets/ang-a06dbacd.png" alt="" className="img-fluid img" />
                    </div>
                </div>
            </div>
            <div className="ioapp-services">
                <div className="d-flex align-items-center justify-content-between">
                    <div className=" ms-md-4 ps-md-4 ioapp-left-holder">
                        <h1> Angular JS <br/>Development Services</h1>
                        <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit,<br/>
        ...
        <section className="angular-project">
        ...
        <section className="angular-business">
         ...
         <section className='angular-solution'>
         ...
         <section className="angular-technology  ">
        ...
        <div className="row gx-3 gy-4  ">
         ...
         <section className="angular-question">
