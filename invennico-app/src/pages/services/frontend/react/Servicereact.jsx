...
function Servicereact() {
  return( 
    ...
    <div className="container-fluid">
      ...
      <main>
        <section className="servicereact-hero">
            <div className="servicereact-hero-holder">
        ...
        <section className="servicereact-project">
        ...
        <section className="servicereact-business">
         ...
         <section className='servicereact-solution'>
         ...
         <section className="servicereact-technology  ">
        ...
        <div className="row gx-3 gy-4  ">
         ...
         <section className="servicereact-question">
