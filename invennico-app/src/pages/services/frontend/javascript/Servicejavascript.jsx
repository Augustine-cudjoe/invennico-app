...
import "./servicejavascript.scss"
import {Link} from "react-router-dom"

function Servicejavascript() {
  return( 
    <div className='servicejavacript'>
    ...
    <div className="container-fluid">
      ...
      <main>
        <section className="servicejavascript-hero">
            <div className="servicejavascript-hero-holder">
                <div className="d-flex gap-4 align-items-center justify-content-center">
                    <div className="left-holder">
                        <h1>Javascript <br/>Development</h1>
                    ...
                    <div className="right-holder">
                        <img src="https://invennico-site.vercel.app/assets/javascript-800dddc4.png" alt="" className="img-fluid img" />
                    </div>
                </div>
            </div>
            <div className="ioapp-services">
                <div className="d-flex align-items-center justify-content-between">
                    <div className=" ms-md-4 ps-md-4 ioapp-left-holder">
                        <h1> Javascript <br/>Development Services</h1>
                        <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit,<br/>
        ...
        <section className="servicejavascript-project">
        ...
        <section className="servicejavascript-business">
         ...
         <section className='servicejavascript-solution'>
         ...
         <section className="servicejavascript-technology  ">
        ...
        <div className="row gx-3 gy-4  ">
         ...
         <section className="servicejavascript-question">
