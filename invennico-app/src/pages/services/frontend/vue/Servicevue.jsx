...
import "./servicevue.scss"
import {Link} from "react-router-dom"

function Servicevue() {
  return( 
    <div className='servicevue'>
    ...
    <div className="container-fluid">
      ...
      <main>
        <section className="servicevue-hero">
            <div className="servicevue-hero-holder">
                <div className="d-flex gap-4 align-items-center justify-content-center">
                    ...
                    <div className="right-holder">
                        <img src="https://invennico-site.vercel.app/assets/vue-2e4e079d.png" alt="" className="img-fluid img" />
                    </div>
                </div>
            </div>
            <div className="ioapp-services">
                <div className="d-flex align-items-center justify-content-between">
                    <div className=" ms-md-4 ps-md-4 ioapp-left-holder">
                        <h1> Vue JS <br/>Development Services</h1>
                        <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit,<br/>
        ...
        <section className="servicevue-project">
        ...
        <section className="servicevue-business">
         ...
         <section className='servicevue-solution'>
         ...
         <section className="servicevue-technology  ">
        ...
        <div className="row gx-3 gy-4  ">
         ...
         <section className="servicevue-question">
