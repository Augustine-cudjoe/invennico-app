...
import "../mobile/hiremobileapp.scss"
  ...
  return (
    ...
    <div className="container-fluid">
     ...
     <main>
        ...
        <h1  className='ms-md-5 ps-md-5'>Why Hire Website Designer from Innvennico</h1>
        ...
        <section className="android-project">
            ...
            <div className="col-md-6">
                ...
                <div className="business-icons ps-md-5">
                   <h4  className=' ps-3'> <span><img className='img-fluid mb-md-3 mb-2' src='https://invennico-site.vercel.app/assets/RingingPhone-1efa64c0.svg'/>  </span> Give us a call</h4>
                       
                    <ul className='ps-md-3 mx-md-0'>
    ...
    <div className="  footer-section  mt-md-5">
        <div className=" mb-md-5 px-3 mx-3  mb-3 mt-md-5">
            <div className=" footer-header">
            <div className="row g-4 mx-3 px-3 mx-md-0 ps-md-0 justify-content-center align-items-center">
                 <div className="col-md-6">
                    <img className='img-fluid ' src='https://invennico-site.vercel.app/assets/Invenicoblack-f045e121.svg'/>
                 </div>
