...
import "../hireandroid/hireandroid.scss"
  ...
  return (
    ...
    <div className="container-fluid">
     ...
     <main>
        ...
        <h1  className='ms-md-5 ps-md-5'>Why Hire Flutter Developer from Innvennico</h1>
        ...
        <section className="clients">
            <div className="client-holder">
                <h1 className='text-center mb-md-3 mt-md-3 fw-bold'>What our clients say about us</h1>
                <div className="slider-container mt-md-5 mt-3">
                    <Slider {...settings1}>
                        <div>
                            <div className="card">
                                <div className="card-body">
                                    <p className="title"> 
                                    One Well deserve Praesent ac nunc nec tellus cursus aliquet. 
                                    Lorem ipsum dolor sit amet,
                                     consectetuer adipiscing elit, sed diam nonummy nibh 
                                     euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. 
                                     Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper
                                    </p>
                                    <div className="d-flex gap-5 align-items-center  mb-md-4 justify-content-center">
                                        <div>
                                            <img src="https://invennico-site.vercel.app/assets/Rectangle3-2c651759.svg" alt="" className="img-fluid img" />
                                        </div>
                                        <div>
                                            <h6 className='fw-bold'> Willis Yaw</h6>
                                            <p> UI/UX Designer</p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div>
                            <div className="card">
                                <div className="card-body">
                                    ...
                                    <div className="d-flex gap-5 align-items-center justify-content-center">
                                        <div>
                                            <img src="https://invennico-site.vercel.app/assets/Rectangle4-d6525108.svg" alt="" className="img-fluid img" />
                                        </div>
                                        <div>
                                            <h6 className='fw-bold'> Jamse Smith</h6>
                                            <p> CEO TT Company</p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div>
                            <div className="card">
                                <div className="card-body">
                                    ...
                                    <div className="d-flex gap-5 align-items-center justify-content-center">
                                        <div>
                                            <img src="https://invennico-site.vercel.app/assets/Rectangle2-6e8aa38d.svg" alt="" className="img-fluid img" />
                                        </div>
                                        <div>
                                            <h6 className='fw-bold'> Frank Doe Thomason</h6>
                                            <p> CEO xyz Company</p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div>
                            <div className="card ">
                                <div className="card-body">
                                    ...
                                    <div className="d-flex gap-5 align-items-center mb-md-4 justify-content-center">
                                        <div>
                                            <img src="https://invennico-site.vercel.app/assets/Rectangle5-b06211c2.svg" alt="" className="img-fluid img" />
                                        </div>
                                        <div>
                                            <h6 className='fw-bold'> John Doe Thomason</h6>
                                            <p> CEO xyz Company</p>
                                        </div>
                                    </div>
                                </div>
