...
function  Hirecrmintegration() {
  ...
  return (
    <div className='Hirecrmintegration'>
    ...
    <div className="container-fluid">
     ...
     <main>
        ...
        <h1  className='ms-md-5 ps-md-5'>Why Hire CRM  API Developer from Innvennico</h1>
...
export default Hirecrmintegration;