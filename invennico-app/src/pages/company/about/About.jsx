...
function About() {
  return (
    ...
    <section className="about-hero">
        <div className="about-hero-holder d-flex flex-column justify-content-center align-items-center">
            <h5 className="text-danger">WHO WE ARE</h5>
            <p className='text-center fs-5'> <strong> We are a Digital-Tech Studio </strong>, consectetuer adipiscing elit, sed diam <br/>
        ...
        <div className="about-hero-content">
            <div className="row g-2 mx-auto mx-md-5 px-md-5">
                <div className="col-md-6">
                    <div className=" card card-left">
                        <img className='img-fluid  pyramid-img' src='https://invennico-site.vercel.app/assets/flag-879e9ab9.svg'/>
                       <p className="card-title px-md-5 px-3 "> Mission</p>
                       <p className="card-body px-md-5 mb-md-5 mb-3 ">
                       Lorem ipsum dolor sit amet consectetur <br/>  adipisicing elit.
                        Fugiat ad, amet quaerat <br/> praesentium quam ut distinctio laborum! <br/>
                        Nostrum tempore voluptas et, ut earum cumque <br/> illum.
                         Delectus odit amet deserunt dicta doloribus <br/> iusto eligendi.
                        Quibusdam, numquam at! Vel <br/> quam iste nulla!
                       </p>
                    </div>
                ...
                <div className="col-md-6">
                    <div className=" card card-right">
                        <img className='img-fluid  pyramid-img' src='https://invennico-site.vercel.app/assets/eye-1c33e787.svg'/>
                       <p className="card-title px-md-5 px-3"> Mission</p>
                       <p className="card-body px-md-5 mb-md-5 mb-3">
                       Lorem ipsum dolor sit amet consectetur <br/>  adipisicing elit.
                        Fugiat ad, amet quaerat <br/> praesentium quam ut distinctio laborum! <br/>
        ...
        <div className="hero-values">
            <div className="d-flex flex-column align-items-center">
                <h6 className='text-center'>OUR VALUES</h6>
                <h1 className="text-center">Lorem ipsum dolor sit amet, consectetuer <br/>
                 adipiscing elit, sed diam nonummy nibh
                 
             </h1>
             <div className="values-card mt-md-5 mt-3">
                <div className="row g-2">
                    <div className="col-md-3">
                    <div className="card integrity-card">
                    <p className="card-title text-center mt-3 fs-3">Integrity</p>
                    <p className="card-body text-center">
                    orem ipsum dolor sit <br/> amet, consectetuer<br/>
                    adipiscing elit, sed diam <br/> nonummy nibh euismod <br/>
                    tincidunt ut laoreet dolore <br/> magna aliquam erat <br/>
                     volutpat. Ut wisi enim ad <br/> minim veniam, quis nostrud
                    </p>
                    </div>
                    </div>
                    <div className="col-md-3">
                    <div className="card account-card">
                    <p className="card-title text-center mt-3 fs-3">Accountability</p>
                    <p className="card-body text-center">
                    orem ipsum dolor sit <br/> amet, consectetuer<br/>
                    adipiscing elit, sed diam <br/> nonummy nibh euismod <br/>
                    tincidunt ut laoreet dolore <br/> magna aliquam erat <br/>
                    ...
                    <p className="card-title text-center mt-3 fs-3">Innovation</p>
                    <p className="card-body text-center">
                    orem ipsum dolor sit <br/> amet, consectetuer<br/>
                    adipiscing elit, sed diam <br/> nonummy nibh euismod <br/>
                    tincidunt ut laoreet dolore <br/> magna aliquam erat <br/>
                    ...
                    <div className="col-md-3">
                    <div className="card teamwork-card">
                    <p className="card-title text-center mt-md-3 mt-3 fs-3">Team Work</p>
                    <p className="card-body text-center">
                    orem ipsum dolor sit <br/> amet, consectetuer<br/>
                    adipiscing elit, sed diam <br/> nonummy nibh euismod <br/>
                    tincidunt ut laoreet dolore <br/> magna aliquam erat <br/>
    ...
    <section className="about-clients">
        <div className="about-clients-holder d-flex flex-column align-items-center ">
            <h6 className='text-start'>OUR CLIENTS</h6>
            <h1 className='text-start' >
            Lorem ipsum dolor sit amet, <br/> consectetuer 
            adipiscing elit, sed  <br/> diam nonummy nibh
            </h1>
            <p className='text-start'>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam <br/>
             nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam  <br/>
             erat volutpat. Ut wisi enim ad minim veniam, quis nostrud exerci <br/>
              tation ullamcorper suscipit lobortis nisl ut aliquip</p>
        </div>
        <div className="about-clients-content">
            <div className="card ms-md-5 ps-md-5 py-md-5   about-clients-card">
                <div className="d-flex justify-content-around  align-items-center">
                    <div className="d-flex  clients align-items-center align-items-center justify-content-center  clients">
                        <p><img className='img-fluid me-md-3 clients-img' src='https://invennico-site.vercel.app/assets/business_center-4c2a834f.svg'/> </p>
                        <div className='d-flex flex-column'>
                        <p className=' mb-md-0 pb-md-0 mb-0 pb-0 clients-text'> 229+</p>
                           <p className='text-center pt-md-0 mt-md-0 mt-0 pt-0 clients-text'>CLIENTS WORKED WITH </p>
                         
                        </div>
                    </div>
                    <div className="d-flex align-items-center domain justify-content-center ">
                          <img className='me-md-2 domain-img'  src='https://invennico-site.vercel.app/assets/diversity_2-b3a95bc7.svg'/> 
                            <div className="d-flex flex-column">
                           <p className=' mb-md-0 pb-md-0 mb-0 pb-0 domain-text'> 15+</p>
                           <p className='text-center pt-md-0 mt-md-0 pt-0 mt-0 domain-text'>DOMAINS WORKED IN</p>
                         
                           </div>
                    </div>
                    <div className="d-flex align-items-center million-card justify-content-center">
                         <img className='me-md-2 million-img' src='https://invennico-site.vercel.app/assets/favorite-a6f6db83.svg'/>
                           <div className="d-flex  flex-column">
                           <p className=' mb-md-0 pb-md-0  mb-0 pb-0 million-text'> MILLIONS</p>
                           <p className='text-center pt-md-0 mt-md-0 pt-0 mt-0 million-text'>HEARTS WON </p>
    ...
    <section className="about-story">
        <div className="about-story-header d-flex align-items-center mb-md-5  mx-3 flex-column">
            <h6 className='text-danger mt-md-5 mt-3 pt-md-5'>OUR STORY</h6>
            <h1>Our Client Presence Across the Globe</h1>
            <p> Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh
                <br/> euismod tincidunt ut laoreet dolore magna aliquam erat volutpat.
            </p>
        </div>
        <div className="about-story-content">
            <div className="d-flex flex-row justify-content-center mx-3 align-items-center">
               <div>
               <img className='img-fluid me-md-5' src='https://invennico-site.vercel.app/assets/Vector(2)-67de1f83.svg'/>
                
               </div>
                <div>
                <img className='img-fluid me-md-5' src='https://invennico-site.vercel.app/assets/Vector(3)-6b8bda20.svg'/>

                </div>
                <div>
                <img className='img-fluid me-md-5' src='https://invennico-site.vercel.app/assets/Vector(4)-ee083662.svg'/>

                </div>
                <div>
                <img className='img-fluid me-md-5' src='https://invennico-site.vercel.app/assets/Vector(5)-79428893.svg'/>

                </div>
                <div>
                <img className='img-fluid me-md-5' src='https://invennico-site.vercel.app/assets/Vector(6)-83d46403.svg'/>
                
                </div>
                <div>
                <img className='img-fluid me-md-5' src='https://invennico-site.vercel.app/assets/Vector(7)-2bcda9f0.svg'/>
                
                </div>
                <div>
                <img className='img-fluid me-md-5' src='https://invennico-site.vercel.app/assets/Vector(8)-88dbaaea.svg'/>
               
                </div>
                <div>
                <img className='img-fluid me-md-5' src='https://invennico-site.vercel.app/assets/Vector(9)-82e0c3ca.svg'/>
          
                </div>
                 </div>
        </div>
        <div className="about-business mx-3 ps-3">
            <div className="d-flex flex-column align-items-center">
            ...
            <div className="d-flex justify-content-center align-items-center">
                <button type='button' className='btn button px-md-5 border-bottom-0 text-white'>Talk to an Expect</button>
            </div>
        </div>
    </section>
