...
function Career() {
    ...
    const expnadToggle =(expandJob)=>{
         setExpand(prev=>({
            ...prev,
            [expandJob]:!prev[expandJob]
         })) 
    }
     ...
     <main>
        <section className="career">
            <div className="career-holder">
                <h1 className='text-center'>Find your perfect role.</h1>
                
                 <div className="d-flex mx-md-5 px-md-5">
                 <div class="input-group mb-3 mx-md-5 px-md-5">
                   <input type="text" className="form-control py-md-2" placeholder="Search role or keyword..." aria-label="Recipient's username" aria-describedby="button-addon2"/>
                  <button className="btn button py-md-2" type="button" id="button-addon2">Button</button>
                </div>
                 </div>
        ...
        <section className="developer">
         <p className=' mb-md-0 pb-md-0 filter'>Filter</p>
            <div className="d-flex  justify-content-center">
                <div className="details-container ms-md-5 ps-md-5">
                   

                  <div>
                  {
                    !expand.button1 ?(<div className=" mb-2">
                    <a className="btn text-start ps-md-3 develop-content p-3" onClick={expnadToggle}
                    data-bs-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample">
                      LOCATION <span> <svg xmlns="http://www.w3.org/2000/svg"  
                                       width="16" height="16" fill="currentColor" className="bi bi-plus float-end" viewBox="0 0 16 16">
                            ...
                            <a className="btn text-start ps-md-3 develop-content p-3" onClick={expnadToggle}
                             data-bs-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample">
                               LOCATION <span> <svg xmlns="http://www.w3.org/2000/svg"  
                                    width="16" height="16" fill="currentColor" className="bi bi-dash float-end" viewBox="0 0 16 16">
                 ...
                 <div className="card card-body content-card">
                    <ul>
                 ...
                 <div>
                  ...
                  <div>
                  {
                    !expand.button2 ?(<div className=" mb-2">
                    <a className="btn text-start ps-md-3 develop-content p-3" onClick={expnadToggle}
                    data-bs-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample">
                      JOB TYPE <span> <svg xmlns="http://www.w3.org/2000/svg"  
                                       width="16" height="16" fill="currentColor" className="bi bi-plus float-end" viewBox="0 0 16 16">
                                    <path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4"/>
                                    </svg>
                                   </span>
                 ...
                 <div>
                  {
                    !expand.button3 ?(<div className=" mb-2">
                    <a className="btn text-start ps-md-3 develop-content p-3" onClick={()=>expnadToggle("button3")}
                    data-bs-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample">
                     CATEGORY <span> <svg xmlns="http://www.w3.org/2000/svg"  
                                       width="16" height="16" fill="currentColor" className="bi bi-plus float-end" viewBox="0 0 16 16">
                                    <path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4"/>
                                    </svg>
                                   </span>
                ...
                <div className="detais-container-card">
                    <div className="card border-top-0 border-end-0 mb-md-3 mb-2 ">
                        <h4 className="ps-md-3">Fluter Developer</h4>
                        <p className="ps-md-3"> <span>
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi me-2 bi-geo-alt" viewBox="0 0 16 16">
                            <path d="M12.166 8.94c-.524 1.062-1.234 2.12-1.96 3.07A32 32 0 0 1 8 14.58a32 32 0 0 1-2.206-2.57c-.726-.95-1.436-2.008-1.96-3.07C3.304 7.867 3 6.862 3 6a5 5 0 0 1 10 0c0 .862-.305 1.867-.834 2.94M8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10"/>
                             <path d="M8 8a2 2 0 1 1 0-4 2 2 0 0 1 0 4m0 1a3 3 0 1 0 0-6 3 3 0 0 0 0 6"/>
                             </svg>
                             </span> <strong>In-office::</strong> Ghana</p>
                         <div className="card-body">
                            <h2>Description Title 1:</h2>
                            <ul>
                                <li>Bachelor’s degree or equivalent practical experience</li>
                                <li> 8 years of experience in email marketing</li>
                                <li>Experience with email service providers</li>
                            </ul>
                            <div className="">
                              <a className="btn  develop-content text-danger " data-bs-toggle="collapse" href="#collapseExample5" role="button" aria-expanded="false" aria-controls="collapseExample">
                             Collapse
                            </a>
                          </div>
                           <div class="collapse" id="collapseExample5">
                       <div className="card card-body degree ">
                       Bachelor’s degree or equivalent practical experience Bachelor’s degree or equivalent practical experience Bachelor’s degree or equivalent practical <br/>
                       experience Bachelor’s degree or equivalent practical experience Bachelor’s degree or
                          <br/> equivalent practical experience.
                    </div>
                           </div>
                        </div>

                    </div>
                    <div className="card mb-md-3 border-top-0 border-end-0 mb-2">
                        <h4 className="ps-md-3">Reactjs Developer</h4>
                        <p className="ps-md-3"><span>
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi me-2 bi-geo-alt" viewBox="0 0 16 16">
                            <path d="M12.166 8.94c-.524 1.062-1.234 2.12-1.96 3.07A32 32 0 0 1 8 14.58a32 32 0 0 1-2.206-2.57c-.726-.95-1.436-2.008-1.96-3.07C3.304 7.867 3 6.862 3 6a5 5 0 0 1 10 0c0 .862-.305 1.867-.834 2.94M8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10"/>
                             <path d="M8 8a2 2 0 1 1 0-4 2 2 0 0 1 0 4m0 1a3 3 0 1 0 0-6 3 3 0 0 0 0 6"/>
                             </svg>
                             </span>  <strong>Jon Type 2:</strong> India</p>
                        <div className="card-body">
                            <h2>Description Title 2:</h2>
                            <ul>
                                <li>Bachelor’s degree or equivalent practical experience</li>
                                <li> 8 years of experience in email marketing</li>
                                <li>Experience with email service providers</li>
                            ...
                            <div className="">
                          <a className="btn  develop-content text-danger" data-bs-toggle="collapse" href="#collapseExample6" role="button" aria-expanded="false" aria-controls="collapseExample">
                            Expand
                            </a>
                          </div>
                    <div class="collapse" id="collapseExample6">
                       <div class="card card-body degree">
                       Bachelor’s degree or equivalent practical experience Bachelor’s degree or equivalent practical experience Bachelor’s degree or equivalent practical <br/>
                       experience Bachelor’s degree or equivalent practical experience Bachelor’s degree or
                          <br/> equivalent practical experience.
                    </div>
                    ...
                    <div className="card border-top-0 border-end-0 ">
                        <h4  className="ps-md-3">React native Developer</h4>
                        <p className="ps-md-3"> <span>
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi me-2 bi-geo-alt" viewBox="0 0 16 16">
                            <path d="M12.166 8.94c-.524 1.062-1.234 2.12-1.96 3.07A32 32 0 0 1 8 14.58a32 32 0 0 1-2.206-2.57c-.726-.95-1.436-2.008-1.96-3.07C3.304 7.867 3 6.862 3 6a5 5 0 0 1 10 0c0 .862-.305 1.867-.834 2.94M8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10"/>
                             <path d="M8 8a2 2 0 1 1 0-4 2 2 0 0 1 0 4m0 1a3 3 0 1 0 0-6 3 3 0 0 0 0 6"/>
