  ...
  return (
    ...
    <div className="container-fluid">
      ...
      <main>
        ...
        <section className="life-stand">
          <div className="d-flex flex-column align-items-center">
          <h1 className='header text-center'>What we stand for</h1>
            <p  className='header-text text-start ' >Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed <br/>
             diam nonummy nibh euismod tincidunt ut laoreet dolore <br/>
              magna aliquam erat volutpat. Ut wisi enim ad <br/>
               minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl <br/>
                ut aliquip ex ean commodo consequat. Duis autem vel eum <br/>
          ...
          <Slider {...settings}>
           <div>
            <img className='img-fluid life-img' src='https://images.unsplash.com/photo-1514999037859-b486988734f1?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MzV8fG9jZWFufGVufDB8'/>
           </div>
           <div>
            <img className='img-fluid life-img' src='https://images.unsplash.com/photo-1509477887414-681937645173?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8NDZ8fG9jZWFufGVufDB8MnwwfHw%3D&auto=format&fit=crop&w=800&q=60'/>
           </div>
           <div>
            <img className='img-fluid life-img' src='https://images.unsplash.com/photo-1478359844494-1092259d93e4?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mzh8fG9jZWFufGVufDB8MnwwfHw%3D&auto=format&fit=crop&w=800&q=60'/>
           </div>
           <div>
            <img className='img-fluid life-img' src='https://images.unsplash.com/photo-1562059392-096320bccc7e?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTJ8fG9jZWFufGVufDB8MnwwfHw%3D&auto=format&fit=crop&w=800&q=60'/>
           </div>
           <div>
            <img className='img-fluid life-img' src='https://images.unsplash.com/photo-1551405780-03882d5a2ba7?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTN8fG9jZWFufGVufDB8MnwwfHw%3D&auto=format&fit=crop&w=800&q=60'/>
           </div>
           <div>
            <img className='img-fluid life-img' src='https://cdn.pixabay.com/photo/2020/01/22/09/38/meeting-4784909__340.jpg'/>
           </div>
          </Slider>
         </div>
          
          </div>
          <div className="life-working">
            <h1 className='text-center fw-bold'>Working at Invennico</h1>
            ...
            <div className="d-flex gap-2  mt-md-5 pt-md-5 middle justify-content-center align-items-center">
                <div className="midle-work mb-3">

                 </div>
                  <div className="midle-end">

                   </div>
                </div>
          </div>
          <div className="life-business mx-md-5 px-md-5">
            <div className="d-flex flex-column align-items-center ">
                <h1>Become Part of Our Awesome Team.</h1>
