      ...
      <div className="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <main>
          <section className="engage-hero">
           <div className="d-flex justify-content-center g-3 align-items-center">
            <div className="hero-hold">
            <h1 className='ms-md-5 fw-bold'> Engagement Model</h1>
           <p className='ms-md-5'>  
           Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam <br/>
            ...
            <div className="hero-img">
                <img className='img-fluid img' src='https://invennico-site.vercel.app/assets/undraw_accept_tasks_re_09mv-87d7c142.svg'/>
            </div>
           </div>
          </section>
          <section className="hybrid">
           <div className="hybrid-holder">
            <div className="d-flex gap-2 align-items-center justify-content-center">
                <div className="left-hybrid">
                    <img className='img-fluid' src='https://invennico-site.vercel.app/assets/undraw_prototyping_process_re_7a6p1-58d42ea2.svg'/>
                </div>
                <div className="right-hybrid">
                    <h1>Hybrid Model</h1>
                  ...
                  <ul>
                    <li> <span>
                         ...
                         <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-check-circle me-2" viewBox="0 0 16 16">
                          ...
                          </span>Consectetuer adipiscing elit, sed diam
                          </li>
                          <li> <span>
                         <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-check-circle me-2" viewBox="0 0 16 16">
                          <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14m0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16"/>
                          ...
                          </span>CNonummy nibh euismod tincidunt ut
                          </li>
                          <li> <span>
                         <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-check-circle me-2" viewBox="0 0 16 16">
                          <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14m0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16"/>
                          ...
                          </span>Laoreet dolore magna aliquam erat
                          </li>
                </ul>
                <div className="d-flex">
                    <button type='button' className='button btn px-md-5'>Engage with us 
                     <span> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" 
                     fill="currentColor" className="bi bi-arrow-right  ms-3" viewBox="0 0 16 16">
           ...
           <div className="hybrid-middle-content">
            <div className="midlle-holder d-flex gap-2 mx-md-5 px-md-5 pt-md-5 mt-md-5 align-items-center justify-content-center">
            <div className="left-midlle-hybrid ">
                    <h4>Hybrid Model</h4>
                    <p>Lorem ipsum dolor sit amet, consectetuer 
                     adipiscing elit,sed diam nonummy <br/> nibh euismod 
                ...
                <div className="d-flex">
                    <button type='button' className='button2 btn px-md-5'>Engage with us 
                     <span> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" 
                     fill="currentColor" className="bi bi-arrow-right  ms-3" viewBox="0 0 16 16">
                    <path fillRule="evenodd" 
                     d="M1 8a.5.5 0 0 1 .5-.5h11.793l-3.147-3.146a.5.5 0 0 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L13.293 8.5H1.5A.5.5 0 0 1 1 8"/>
            ...
            <div className="right-midlle-hybrid">
                <img className='img-fluid' src='https://invennico-site.vercel.app/assets/undraw_organizing_projects_re_9p1k1-2d50ec6c.svg'/>
            </div>
            </div>
           </div>
           <div className="hybrid-button-content mt-md-5 pt-md-5">
            <div className="d-flex justify-content-center align-items-center">
              <div className="hybrid-button-img">
                <img src="https://invennico-site.vercel.app/assets/undraw_work_time_re_hdyv1-11af2cbe.svg" alt="" className="img-fluid" />
              </div>
              <div className="button-right-hybrid">
              <h4>Hybrid Model</h4>
                    <p>Lorem ipsum dolor sit amet, consectetuer 
                     adipiscing elit,sed diam nonummy <br/> nibh euismod 
                      tincidunt ut laoreet dolore magna aliquam erat 
                ...
                <div className="d-flex">
                    <button type='button' className='button1 btn px-md-5'>Engage with us 
                     <span> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" 
                     fill="currentColor" className="bi bi-arrow-right  ms-3" viewBox="0 0 16 16">
                    <path fillRule="evenodd" 
                     d="M1 8a.5.5 0 0 1 .5-.5h11.793l-3.147-3.146a.5.5 0 0 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L13.293 8.5H1.5A.5.5 0 0 1 1 8"/>
          ...
          <section className="technology  mt-md-5">
          <div className="row g-2 teach-content mx-md-5 justify-content-center align-items-center ">
            <div className="col-md-6">
                <div className="business-holder ps-md-4">
                    <h5 className='fw-bolder fs-1 ps-md-4'>Let’s Talk</h5>
                    <h1 className='ps-md-3'>Business!</h1>
                    <p className='ps-md-3'>Have questions about your idea? Drop <br/>
