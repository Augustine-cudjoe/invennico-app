...
function Employement() {
  return (
    ...
    <div className="container-fluid">
     ...
     <main>
      <section className="hero-employement">
        <div className="d-flex gap-3 align-items-center justify-content-center">
            <div className="first-img">
                <img src="https://invennico-site.vercel.app/assets/employee1-a4e31cad.png" alt="" className="img-fluid img" />
            </div>
            <div className="first-text">
                <p className='fs-4 float-start'>“ Lorem ipsum dolor sit amet, <br/> 
              ...
              <div>
                <h1>Name</h1>
                <hp className='fs-2'>Product Manager</hp>
              </div>
            </div>
        </div>
        <div className="d-flex gap-5 align-items-center second-employ justify-content-center">
          <div className="second-text">
            ...
            <div className="second-img">
                <img src="https://invennico-site.vercel.app/assets/employee2-999e1296.png" alt="" className="img-fluid img" />
            </div>
            
        </div>
        <div className="d-flex gap-3 align-items-center  third-employ justify-content-center">
            <div className="first-img">
                <img src="https://invennico-site.vercel.app/assets/employee3-7a5c6fa1.png" alt="" className="img-fluid img" />
            </div>
            <div className="first-text">
                <p className='fs-4 float-start'>“ Lorem ipsum dolor sit amet, <br/> 
                consectetuer adipiscing elit, sed diam <br/>
        ...
        <div className="d-flex gap-5 align-items-center second-employ justify-content-center">
          <div className="second-text">
            ...
            <div className="second-img">
                <img src="https://invennico-site.vercel.app/assets/employee4-d13b73d1.png" alt="" className="img-fluid img" />
            </div>
